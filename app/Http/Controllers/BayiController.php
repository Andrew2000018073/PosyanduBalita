...
class BayiController extends Controller
{
    ...
    public function getberatbadanumurByDate($date)
    {
        $inputDate = \Carbon\Carbon::createFromFormat('d-m-Y', $date);
        $inputMonth = $inputDate->format('m');
        $inputYear = $inputDate->format('Y');

        $bayis = Bayi::with(['PeriksaBalita' => function ($query) use ($inputMonth, $inputYear) {
            $query->join('kegiatan_posyandus', 'periksa_balitas.kegiatanposyandu_balita_id', '=', 'kegiatan_posyandus.id')
                ->whereHas('Kegiatanposyandu', function ($subQuery) use ($inputMonth, $inputYear) {
                    $subQuery->where('status_kegiatan', 'selesai')->whereMonth(DB::raw("STR_TO_DATE(tgl_kegiatan, '%d-%m-%Y')"), $inputMonth)
    ...
    public function getberatbadanumurposByDate($id, $date)
    {
        $inputDate = \Carbon\Carbon::createFromFormat('d-m-Y', $date);
        $inputMonth = $inputDate->format('m');
        $inputYear = $inputDate->format('Y');
    ...
    public function gettinggibadanumurByDate($date)
    {
        $inputDate = \Carbon\Carbon::createFromFormat('d-m-Y', $date);
        $inputMonth = $inputDate->format('m');
        $inputYear = $inputDate->format('Y');
    ...
    public function gettinggibadanumurposByDate($id, $date)
    {
        $inputDate = \Carbon\Carbon::createFromFormat('d-m-Y', $date);
        $inputMonth = $inputDate->format('m');
        $inputYear = $inputDate->format('Y');
    ...
    public function getberatbadantinggiByDate($date)
    {
        $inputDate = \Carbon\Carbon::createFromFormat('d-m-Y', $date);
        $inputMonth = $inputDate->format('m');
        $inputYear = $inputDate->format('Y');
    ...
    public function getberatbadantinggiPosByDate($id, $date)
    {
        $inputDate = \Carbon\Carbon::createFromFormat('d-m-Y', $date);
        $inputMonth = $inputDate->format('m');
        $inputYear = $inputDate->format('Y');
