...
class PosyanduExport implements WithMultipleSheets
{
    ...
    public function sheets(): array
    {
        return [
            ...
            'From 3' => new WuspusRegis($this->idPosyandu,  $this->tahun), // Sheet 2
            'From 4' => new RegBumil($this->idPosyandu,  $this->tahun), // Sheet 2
            'From 5' => new RangkumanPosyandu($this->idPosyandu,  $this->tahun), // Sheet 2
            'From 6' => new HasilKegiatan($this->idPosyandu,  $this->tahun), // Sheet 2
        ];
    }
}
